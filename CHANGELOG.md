**0.15.1** (in progress, last updated 27 January 2022)
...
- Tag continuation closures (generated by the `with continuations` macro), for introspection.
  ...
  - The information is stored as an attribute on the function object; keep this in mind if you intend to wrap the continuation function with another function. (Strictly, this is the correct behavior, since the wrapper is not a continuation function generated by the `with continuations` macro.)
