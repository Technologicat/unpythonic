...
TODO:
  - make a separate project on GitHub
  - clean up the separate project
    - figure out a consistent philosophy
    - remove any unnecessary stuff not in line with that
  - package as a library, with setuptools
  - upload to PyPI
