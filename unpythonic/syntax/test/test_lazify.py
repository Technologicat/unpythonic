...
#    with show_expanded:
    ...
    with lazify:
        ...
        assert letseq[((a, 2), (a, 2 * a), (a, 2 * a)) in a] == 8  # name shadowing, no infinite loop  # noqa: F821, `letseq` defines `a` here.
    ...
    with curry, lazify:
        ...
        assert letrec[((c, 42), (d, 1 / 0), (e, 2 * c)) in [local[x << f(e)(d)],  # noqa: F821, `letrec` defines `x` here.
                                                            x / 2]] == 42  # noqa: F821
