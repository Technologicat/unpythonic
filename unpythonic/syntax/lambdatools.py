...
def multilambda(block_body):
    ...
    return transform.recurse(block_body)
...
def quicklambda(block_body):
    ...
    return [transform.recurse(stmt) for stmt in block_body]
